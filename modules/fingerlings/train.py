#!/usr/bin/env python3
"""
Train YOLO model for Fish Fingerlings Detection and Counting
"""
import argparse
import torch
...
def train_fingerlings(
    ...
    """
    Train YOLO model for fingerlings detection
    
    Args:
        data_yaml: Path to dataset YAML (e.g., 'FINGERLINGS-DATASET-NEW-1/data.yaml')
    ...
    """
    print("="*60)
    print("🐟 FISH FINGERLINGS TRAINING")
    print("="*60)
    ...
    results = model.train(
        ...
        imgsz=imgsz,
        batch=batch,
        project='modules/fingerlings/runs/detect',  # Save in module directory
        name=name,
        patience=patience,
        device=device,
...
def main():
    parser = argparse.ArgumentParser(description="Train YOLO for Fish Fingerlings Detection")
    parser.add_argument("--data", default="modules/fingerlings/dataset/data.yaml", help="Path to dataset YAML")
    parser.add_argument("--model", default="yolo11n.pt", help="Base model")
    parser.add_argument("--epochs", type=int, default=100, help="Number of epochs")
    parser.add_argument("--imgsz", type=int, default=640, help="Image size")
    parser.add_argument("--batch", type=int, default=4, help="Batch size")
    parser.add_argument("--name", default="fingerlings_training", help="Run name")
