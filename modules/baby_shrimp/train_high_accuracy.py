#!/usr/bin/env python3
"""
High Accuracy Training Script for Baby Shrimp Detection
...
def train_high_accuracy(
    ...
    data_yaml='modules/baby_shrimp/dataset/data.yaml',
    ...
    print("="*60)
    print("🎯 HIGH ACCURACY TRAINING MODE - BABY SHRIMP")
    print("="*60)
    ...
    results = model.train(
        ...
        imgsz=imgsz,
        batch=batch,
        project='modules/baby_shrimp/runs/detect',
        name=name,
        patience=patience,
        device=device,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='High Accuracy Training for Baby Shrimp Detection')
    ...
    parser.add_argument('--name', type=str, default='baby_shrimp_high_accuracy',
